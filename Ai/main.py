...
from DataStore import DATA_DIR, get_courses, list_profiles, load_profile, save_profile
...
def sample_profile() -> dict:
    ...
    profile = build_profile(student, availability, course_inputs, courses)
...
def command_create() -> None:
    profile = collect_profile(get_courses())
...
def command_prompt(student_id: str | None) -> None:
    ...
    prompt = build_planning_prompt(profile, get_courses())
...
def command_update(student_id: str | None) -> None:
    ...
    updated_profile = apply_weekly_progress(profile, progress, get_courses())
...
def main() -> None:
    ...
    if args.command == "create":
        ...
        command_prompt(args.student_id)
    elif args.command == "plan":
        command_plan(args.student_id)
    elif args.command == "update":
        command_update(args.student_id)
    else:
        parser.print_help()
